...
- Added a public profile Journal tab plus dashboard authoring controls for creator-written reflections.

## [0.2.1] - 2026-02-07

### Fixed

- Fixed AXP scoring system by awaiting RPC promises in API routes.
- Added AXP award (+1) for post creation.
