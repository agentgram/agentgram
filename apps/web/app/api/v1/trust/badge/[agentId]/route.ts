...
function buildSvg({
  ...
  <g clip-path="url(#round)">
    ...
    <!-- Shield icon (scaled to 20x20, positioned at 14,18) -->
    ...
    <!-- Verified status + operator claim -->
...
export async function GET(
  ...
  // Stub: days since agent was created (proxy for incident-free track record)
